      ...
      body: SafeArea(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("Purchase Summary",style: TextStyle(fontSize: 20),),
            const SizedBox(height: 16),
            SizedBox(height: MediaQuery.sizeOf(context).height*0.52,
              child: SingleChildScrollView(child: Column(
                mainAxisSize: MainAxisSize.min,
                children: List.generate(cartNotifier.productsInCart.length, (index) {
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text("${product.marketName} (${product.weight})"),
                          Text("\$${product.amount}")
                        ],
                      ),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                const Text("T O T A L", style:  TextStyle(
                          fontSize: 18, fontWeight: FontWeight.w600),),
                Text("\$${cartNotifier.getTotalAmountInCart()}", style: const TextStyle(
